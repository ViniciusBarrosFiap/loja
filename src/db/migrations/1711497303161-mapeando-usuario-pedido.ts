...
export class MapeandoUsuarioPedido1711497303161 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "produtos" ADD "quantidade_disponivel" integer NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "produtos" DROP COLUMN "quantidade_disponivel"`);
