...
export class MapeandoUsuarioPedido1711497303161 implements MigrationInterface {
  name = 'MapeandoUsuarioPedido1711497303161';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "pedidos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "valor_total" integer NOT NULL, "status" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "usuarioId" uuid, CONSTRAINT "PK_ebb5680ed29a24efdc586846725" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "produtos" ADD "quantidade_disponivel" integer NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "produtos" DROP COLUMN "quantidade_disponivel"`,
    );
    await queryRunner.query(
      `ALTER TABLE "produtos" ADD "quantidade" integer NOT NULL`,
    );
    await queryRunner.query(
